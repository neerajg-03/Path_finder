...
locations = [
    {"name": "India Gate", "category": "monument", "avgTime": 30, "rating": 4.5},
    {"name": "Qutub Minar", "category": "monument", "avgTime": 60, "rating": 4.7},
    {"name": "Red Fort", "category": "monument", "avgTime": 90, "rating": 4.6},
    ...
    {"name": "National Museum", "category": "museum", "avgTime": 120, "rating": 4.5},
...
if __name__ == "__main__":
    ...
    current_location_name = "Connaught Place"  # We'll fetch the coordinates for this using the API
    available_time =120   # Total available time in minutes (6 hours)
